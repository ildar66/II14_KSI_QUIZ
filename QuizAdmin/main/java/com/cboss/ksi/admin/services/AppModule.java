package com.cboss.ksi.admin.services;

import java.io.IOException;

import com.cboss.ksi.admin.services.impl.QuestionOptionEncoder;
...
public class AppModule
{
    ...
    public static void provideEncoders(MappedConfiguration<Class<?>, ValueEncoderFactory<?>> configuration,
         ...
         contributeEncoder(configuration, QuestionOption.class, new QuestionOptionEncoder(dictionaryDao));
